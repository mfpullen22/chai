    ...
    return (
        <div>
            <p className="text-base text-left tracking-tight text-gray-900">
                ...
                who have a CD4 cell count less than 100 cells/mm<sup>3</sup> and may be considered at a higher CD4 cell count threshold of
                less than 200 cells/mm<sup>3</sup>.
            </p>
            <p className="ml-8 mt-4 text-base text-left tracking-tight text-gray-900">
                ...
                present, a lumbar puncture should be performed (if feasible) and CSF examined by CrAg (or India Ink, of CrAg assay not available) to rule
                out active cryptococcal disease.
            </p>
            <p className="mt-4 text-base text-left tracking-tight text-gray-900">
                ...
                have a CD4 cell count less than 100 cells/mm<sup>3</sup> and may be considered at a higher CD4 cell count threshild of less than 200
                cells/mm<sup>3</sup>.
            </p>
            <p className="mt-4 text-base text-left tracking-tight text-gray-900">
                Screening and primary prophylaxis are not recommended in children owing to low incidence of cryptococcal meningitis in this age group.
            </p>
        </div>
    )
}
